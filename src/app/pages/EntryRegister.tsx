...
import { products, suppliers, users } from "../data/mockData";
    ...
    <div className="p-4 lg:p-8 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 lg:p-8">
        <div className="space-y-6">
          {/* Sección: Información de Entrada */}
          <div>
              ...
              {selectedProduct && (
                <div className="md:col-span-2 p-4 bg-blue-50 rounded-lg border border-blue-100">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <p className="text-blue-600 mb-1">Proveedor Actual</p>
                      <p className="font-semibold text-gray-900">{selectedProduct.supplier || 'N/A'}</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          {formData.productId && formData.quantity > 0 && (
            <>
              ...
              <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                <h3 className="font-semibold text-gray-900 mb-3">Resumen de la Entrada</h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-green-700">+{formData.quantity} unidades</span>
                  </div>
                  <div className="flex justify-between">
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium shadow-md hover:shadow-lg"
            >
